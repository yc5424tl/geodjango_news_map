...
export NEWS_MAP_DB_USER=${CONN_STR_LIST[0]:1:-1} && \
export NEWS_MAP_DB_PW=${CONN_STR_LIST[1]:1:-1} && \
export NEWS_MAP_DB_HOST=${CONN_STR_LIST[2]:1:-1} && \
export NEWS_MAP_DB_PORT=${CONN_STR_LIST[3]:1:-1} && \
export NEWS_MAP_DB_NAME=${CONN_STR_LIST[4]:1:-1} && \
export PORT=8000;fi
